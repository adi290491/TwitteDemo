...
public class Sender {
    ...
    public void setProtected(String mProtected) {
    ...
    public String getShow_all_inline_media() {
        return show_all_inline_media;
    }

    public void setShow_all_inline_media(String show_all_inline_media) {
    ...
    public String toString() {
        return "ClassPojo [location = " + location + ", default_profile = " + default_profile + ", statuses_count = " + statuses_count + ", profile_background_tile = " + profile_background_tile + ", lang = " + lang + ", profile_link_color = " + profile_link_color + ", id = " + id + ", following = " + following + ", protected = " +
        mProtected
        +", favourites_count = " + favourites_count + ", profile_text_color = " + profile_text_color + ", verified = " + verified + ", description = " + description + ", contributors_enabled = " + contributors_enabled + ", profile_sidebar_border_color = " + profile_sidebar_border_color + ", name = " + name + ", profile_background_color = " + profile_background_color + ", created_at = " + created_at + ", default_profile_image = " + default_profile_image + ", followers_count = " + followers_count + ", profile_image_url_https = " + profile_image_url_https + ", geo_enabled = " + geo_enabled + ", profile_background_image_url = " + profile_background_image_url + ", profile_background_image_url_https = " + profile_background_image_url_https + ", follow_request_sent = " + follow_request_sent + ", url = " + url + ", utc_offset = " + utc_offset + ", time_zone = " + time_zone + ", notifications = " + notifications + ", profile_use_background_image = " + profile_use_background_image + ", friends_count = " + friends_count + ", profile_sidebar_fill_color = " + profile_sidebar_fill_color + ", screen_name = " + screen_name + ", id_str = " + id_str + ", show_all_inline_media = " + show_all_inline_media + ", profile_image_url = " + profile_image_url + ", is_translator = " + is_translator + ", listed_count = " + listed_count + "]";
    }
}